...
外部 API のキーは要りません。Gemini・駅すぱあと・Speech はモックで動くので、
...
4. 写真を見ながらの語りを録音 → 人物・出来事を候補として抽出（家族が承認するまで未確定）
5. 確定した場所の現況（現存 / 建替え / 廃止）を確かめ、親の体力に合わせて休憩を挟んだ旅程を作る
6. アルバムや写真は期限つきリンクで家族に共有する
