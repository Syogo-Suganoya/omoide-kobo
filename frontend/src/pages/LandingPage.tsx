...
const STORIES = [
  ...
  },
  {
    ...
    answer:
      "看板の文字・駅舎の意匠・車両の型式・服装・地形から、撮影地の候補を確度つきで出します。「木造駅舎の妻面が一致」といった根拠まで見せるので、親も記憶をたぐりやすくなります。違っていれば訂正でき、その訂正を踏まえて推定し直します。",
  },
  {
    art: <ArtTrip />,
